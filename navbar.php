    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">
                <!-- icons -->
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="26" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
        ...
        <img src="/assets/logo.svg" alt="Logo" width="30" height="26">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#navBurgerMenuContents" aria-controls="navBurgerMenuContents" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse justify-content-end">
                ...
                <form class="d-flex me-5" role="search" action="search.php" method="GET">
                    <input class="form-control me-2" name="search" type="search" placeholder="Suche..." aria-label="Search">
            ...
            <div class="d-lg-none offcanvas offcanvas-end" tabindex="-1" id="navBurgerMenuContents" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <?php
                            if (isset($_SESSION['id'])) {
                                echo "<a class='nav-link active' href='profile.php?id=" . $_SESSION['id'] . "'>";
                            } else {
